...
<body>
    <main class="singup">
        <section class="singup__container">
            <div class="singup__actions"><a class="button" href="{{ route('home') }}">Home</a>
                <form class="singup__form" action="/registration-action" method="post">
                    @csrf

                    <div class="default-input default-input_rich">
                        <input class="default-input__input" type="text" require name="name" placeholder="" />
                    ...
                    <div class="default-input default-input_rich">
                        <input class="default-input__input" type="email" name="email" require placeholder="" />
                        <div class="default-input__icon-and-name">
                    ...
                    <div class="default-input default-input_rich">
                        <input class="default-input__input" type="password" name="password" require placeholder="" />
                        <div class="default-input__icon-and-name">
                    ...
                    <div class="default-input default-input_rich">
                        <input class="default-input__input" type="password" name="password_confirmation" require placeholder="" />
                        <div class="default-input__icon-and-name">
            ...
            <picture>
                ...
                <img class="singup__illustration" src="{{ Vite::asset('resources/images/old-phone.png') }}" alt="Old Phone">
            </picture>
        </section>
    </main>
